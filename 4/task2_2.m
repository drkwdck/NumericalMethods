...
u_0 = [0; ub*r1/(r1+r2); ub*r1/(r1+r2); ub; 0; 0];
G = [-c1 c1 0 0 0 0;c1 -c1 0 0 0 0;0 0 -c2 0 0 0;0 0 0 -c3 c3 0;...
...
last_u_values = zeros(u_dimension, length(tau));

for j = 1:1:size(tau, 2)
    [u,t] = rosenbrock_autonomization(@F_autonomization, G, t_start, t_end, u_0, alpha, tau(j));
    last_u_values(:,j) = u(:,end);
end
